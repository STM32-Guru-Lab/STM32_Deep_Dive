/**
 * @file main.c
 * @brief Entprellungs-Demonstration für mechanische Taster
 *
 * Hardware:
 ...
 *
 * Software:
 * - SysTick-basierte 1ms Zeitbasis
 * - Nicht-blockierende Entprellungs-Zustandsmaschine (debounce.c/h)
 * - Prellen-Zähler für Statistik
